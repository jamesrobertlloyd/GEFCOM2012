...
\begin{frame}{Main approach - regression on time and temp.}
  ...
  \begin{block}{Notation}
    $t$ --- Time, $T$ --- Temperature, $S$ --- Kernel smoothed temperature $\bar{S}$ --- Historical average of smoothed temperature, $Z$ --- Load, $f,g$ --- Generic functions, $\varepsilon$ --- Generic error
  \end{block}
\end{frame}
