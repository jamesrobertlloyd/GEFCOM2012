...
\TBD{
This visual analysis revealed a large discontinuity in load series 10 \dots and series 9 was seen to be very different to the other ones \dots
}
No other large anomalies were detected during the first inspection of the data and smaller irregularities were not revisited since the algorithms detailed below performed acceptbaly well without further data cleaning.
...
The time series for zone 10 had a very large discontinuity\fTBD{reference plot}.
...
Automatic selection of kernel functions is an active area of research; recent publications include an automated search over kernel expressions including those used here by \cite{duvenaud2013structure} and a new class of kernels designed to have good extrapolation performance by \cite{wilson2013gaussian}.
