...
This visual analysis revealed a large discontinuity in load series 10 and series 9 was observed to have atypical dynamics (see figure~\ref{fig:load} and others for comparison).
...
Automatic selection of kernel functions is an active area of research; recent publications include an automated search over kernel expressions including those used here by \cite{duvenaud2013structure}, using deep neural networks  to learn a kernel function by \cite{salakhutdinov2008using} and a new class of kernels designed to have good extrapolation performance by \cite{wilson2013gaussian}.
